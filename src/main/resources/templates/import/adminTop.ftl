    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-example">
            <ul class="nav navbar-nav">
                <li><a href="/zer02/"><i class="icon-list-ol"></i> 基础数据</a></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-group"></i> 用户管理<b
                                class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="/zer02/user/list">用户列表</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-th-list"></i> 文章管理<b
                                class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="/zer02/article/tag/list">文章标签</a></li>
                        <li><a href="/zer02/article/list">文章管理</a></li>
                    </ul>
                </li>
                <li><a href="/zer02/link/list"><i class="icon-smile"></i>友情连接</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="/zer02/logout"><i class="icon-signout"></i> 退出登陆</a></li>
                    </ul>
                </li>
