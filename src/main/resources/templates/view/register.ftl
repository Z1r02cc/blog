        ...
        <div class="panel-body">
            <form class="form-horizontal" action="/userRegister" method="post" id="RegisterUserForm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="email" maxlength="35" name="email"
                               placeholder="纯属摆设的一项(随便输入就行)">
                    </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
    function userRegister() {
        ...
        if (!checkNotNull(userEmail) || userEmail.length > 35 || userEmail.length < 3) {
            zuiMsg("邮箱在3-35个字符之间")
            return;
        }
